...
const fetchProvidersFilmeUtils = async (filmeID) => {
  try {
    const response = await fetch(`https://api.themoviedb.org/3/movie/${filmeID}/watch/providers`, api);
...
export default fetchProvidersFilmeUtils;
